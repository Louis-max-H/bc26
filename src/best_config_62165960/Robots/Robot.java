...
import best_config_62165960.Utils.MapLocations;
import best_config_62165960.Utils.MapLocationsWithId;
import best_config_62165960.Utils.Tools;
...
public class Robot {
    ...
    public State best_config_62165960State;
    ...
    public void run(RobotController rc) throws GameActionException {
        ...
        endTurn = new EndTurn();
        best_config_62165960State = init;
        init();
        ...
        while (true) {
            ...
            // Playing state
            header("\t" + best_config_62165960State.name + "\t" + Clock.getBytecodeNum());
            Result result = best_config_62165960State.run();
            ...
            switch(result.code){
                case LOCK:
                    ...
                    rc.setIndicatorString("LOCK " + best_config_62165960State.name);
                    endTurn.run();
                    init.run();
                    avoidCat.run();
                    break;
                ...
                case END_OF_TURN:
                    rc.setIndicatorString("END_OF_TURN " + best_config_62165960State.name);
                    print("Skipping to end of turn");
                    best_config_62165960State = endTurn;
                    break;
