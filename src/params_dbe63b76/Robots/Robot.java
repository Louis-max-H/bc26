...
import params_dbe63b76.Utils.MapLocations;
import params_dbe63b76.Utils.MapLocationsWithId;
import params_dbe63b76.Utils.Tools;
...
public class Robot {
    ...
    public State params_dbe63b76State;
    ...
    public void run(RobotController rc) throws GameActionException {
        ...
        while (true) {
            ...
            // Playing state
            header("\t" + params_dbe63b76State.name + "\t" + Clock.getBytecodeNum());
            Result result = params_dbe63b76State.run();
            ...
            switch(result.code){
                case LOCK:
                    ...
                    rc.setIndicatorString("LOCK " + params_dbe63b76State.name);
                    endTurn.run();
                    init.run();
                    avoidCat.run();
                    break;
                ...
                case END_OF_TURN:
                    rc.setIndicatorString("END_OF_TURN " + params_dbe63b76State.name);
                    print("Skipping to end of turn");
                    params_dbe63b76State = endTurn;
                    break;
