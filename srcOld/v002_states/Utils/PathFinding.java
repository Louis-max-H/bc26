...
import static v002_states.States.Code.CANT;
...
public class PathFinding {
    ...
    public static void addScoresWithNormalization(int[] newScores, int coef){
        ...
        /** Normalize to    100.000 # Easy to remember
         *  Max int is 2147.483.647
         *               10.000.000 with coef of 100
         *             1000.000.000 with 100 different coefs
         *
         *  Values should not exceed coef*normalize/2, or we will have normalization = 0
         * */
        int normalize = 100_000 * coef / max;
