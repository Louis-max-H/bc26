...
public class Spawn extends State {
    ...
    public Result run() throws GameActionException {
        ...
        // Add buffer for potential spawn costs (v007_saketh_reviewed1 cost can be up to ~50+)
        int minCheeseFor200Rounds = 400 + 100; // 400 for consumption + 100 buffer = 500 minimum
        
        // More conservative: calculate based on v007_saketh_reviewed1 spawn cost too
        int v007_saketh_reviewed1SpawnCost = rc.getCurrentRatCost();
        int conservativeBuffer = minCheeseFor200Rounds + v007_saketh_reviewed1SpawnCost; // Always have enough for one spawn + 200 rounds
        ...
        int cheeseAfterSpawn = cheeseStock - v007_saketh_reviewed1SpawnCost;
        ...
        if(v007_saketh_reviewed1SpawnCost > maxAcceptableCost){
            return new Result(OK, "Cost too high: " + v007_saketh_reviewed1SpawnCost + " (max: " + maxAcceptableCost + ")");
        }
