...
import v007_saketh_reviewed1.Utils.MapLocations;
import v007_saketh_reviewed1.Utils.MapLocationsWithId;
...
public class Robot {
    ...
    public State v007_saketh_reviewed1State;
    ...
    public void run(RobotController rc) throws GameActionException {
        ...
        init = new Init();
        endTurn = new EndTurn();
        v007_saketh_reviewed1State = init;
        init();
        ...
        while (true) {
            // Playing state
            header("\t" + v007_saketh_reviewed1State.name + "\t" + Clock.getBytecodeNum());
            Result result = v007_saketh_reviewed1State.run();
            ...
            switch(result.code){
                ...
                case END_OF_TURN:
                    ...
                    v007_saketh_reviewed1State = endTurn;
                    break;
